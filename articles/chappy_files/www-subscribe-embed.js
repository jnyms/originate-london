...
var db=p.document,eb=db&&A?Xa()||("CSS1Compat"==db.compatMode?parseInt(bb,10):5):void 0;!Ua&&!A||A&&9<=Number(eb)||Ua&&cb("1.9.1");var fb=A&&!cb("9");function hb(a){return a?new ib(jb(a)):oa||(oa=new ib)}
...
yd(a,"tooltip-show-timer",b.toString());a.title&&(Fd(a,Id(a)),a.title="");b=(a[ga]||(a[ga]=++ja)).toString();this.f[b]=a}};
...
b=Ob(b,50);yd(a,"tooltip-hide-timer",b.toString());if(b=Q(a,"tooltip-text"))a.title=b;b=(a[ga]||(a[ga]=++ja)).toString();delete this.f[b]};
...
function Nd(a,b,c,d,e,f){Ga(c,R(a,"tip-reverse"),f);var g=0;f&&(g=1);a=fd(b);f=new y((a.b-10)/2,f?a.f:0);var h=jb(b),k=new y(0,0),l;l=h?jb(h):document;l=!A||9<=Number(eb)||mb(hb(l).b)?l.documentElement:l.body;if(b!=l){l=dd(b);var n=hb(h).b,h=n.scrollingElement?n.scrollingElement:!Va&&mb(n)?n.documentElement:n.body||n.documentElement,n=n.parentWindow||n.defaultView,h=A&&cb("10")&&n.pageYOffset!=h.scrollTop?new y(h.scrollLeft,h.scrollTop):new y(n.pageXOffset||h.scrollLeft,n.pageYOffset||h.scrollTop);
k.i=l.left+h.i;k.l=l.top+h.l}f=new y(k.i+f.i,k.l+f.l);f=new y(f.i,f.l);k=(g&8&&"rtl"==cd(c,"direction")?g^4:g)&-9;g=fd(c);h=new z(g.b,g.f);l=f;l=new y(l.i,l.l);h=new z(h.b,h.f);0!=k&&(k&4?l.i-=h.b+0:k&2&&(l.i-=h.b/2),k&1&&(l.l-=h.f+0));f=new bd(0,0,0,0);f.left=l.i;f.top=l.l;f.f=h.b;f.b=h.f;l=new y(f.left,f.top);l instanceof y?(k=l.i,l=l.l):(k=l,l=void 0);c.style.left=ed(k);c.style.top=ed(l);h=new z(f.f,f.b);if(!(g==h||g&&h&&g.b==h.b&&g.f==h.f))if(g=h,k=mb(hb(jb(c)).b),!A||cb("10")||k&&cb("8"))f=c.style,
...
function Ee(a,b,c){function d(a,b){if(X)return 0;Td.clearTimeout(n);sa.push.apply(sa,S);var d=(($d||{}).config||{}).update;d?d(f):f&&V(Y,"cu",[]).push(f);if(b){fe("me0",a,gb);try{Be(b,c,l)}finally{fe("me1",a,gb)}}return 1}
a=Zd(a)||[];var e=b.callback,f=b.config,g=b.timeout,h=b.ontimeout,k=b.onerror,l=void 0;"function"==typeof k&&(l=k);var n=null,X=!1;if(g&&!h||!g&&h)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var k=V(ce(c),"r",[]).sort(),sa=V(ce(c),"L",[]).sort(),gb=[].concat(k);0<g&&(n=Td.setTimeout(function(){X=!0;h()},g));
var S=xe(a,sa);if(S.length){var S=xe(a,k),ha=V(Y,"CP",[]),ia=ha.length;ha[ia]=function(a){function b(){var a=ha[ia+1];a&&a()}
function c(b){ha[ia]=null;d(S,a)&&be(function(){e&&e();b()})}
if(!a)return 0;fe("ml1",S,gb);0<ia&&ha[ia-1]?ha[ia]=function(){c(b)}:c(b)};
if(S.length){var ac="loaded_"+Y.I++;$d[ac]=function(a){ha[ia](a);$d[ac]=null};
a=ne(c,S,"gapi."+ac,k);k.push.apply(k,S);fe("ml0",S,gb);b.sync||Td.___gapisync?ye(a):ze(a)}else ha[ia](Wd)}else d(S)&&e&&e()}
...
Ne.prototype.f=function(a){if(this.w){a={isSubscribed:a};try{var b=q("gapi.iframes.SAME_ORIGIN_IFRAMES_FILTER");this.w.send("msg-hovercard-subscription",a,void 0,b)}catch(c){}}};function Qe(a){if(da(a))return Re(a);if(fa(a)&&!ea(a)&&!(fa(a)&&0<a.nodeType))return Se(a);try{return p.JSON.stringify(a),a}catch(b){}}
...
S:function(){G(Bc,f)}})}
function Bf(a,b,c){if(null!==b&&(null!==b.b||null!==b.g||null!==b.f)){var d={};a&&(d.channel_id=a);null!==b.b&&(d.receive_all_updates=b.b);null!==b.g&&(d.receive_post_updates=b.g);null!==b.f&&(d.receive_no_updates=b.f);Vc("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",B:d,onError:function(){c&&c()}})}}
